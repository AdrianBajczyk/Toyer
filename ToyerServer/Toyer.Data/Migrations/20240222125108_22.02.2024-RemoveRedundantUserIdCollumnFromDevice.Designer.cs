...
namespace Toyer.Data.Migrations
{
    ...
    [Migration("20240222125108_22.02.2024-RemoveRedundantUserIdCollumnFromDevice")]
    partial class _22022024RemoveRedundantUserIdCollumnFromDevice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Toyer.Data.Entities.Device", b =>
                {
                    ...
                    b.HasOne("Toyer.Data.Entities.UserDevices", null)
                        .WithMany("Devices")
                        .HasForeignKey("UserDevicesUserId");
